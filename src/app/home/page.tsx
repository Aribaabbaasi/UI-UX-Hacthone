...
<nav className='w-[1321px] h[74px] justify-between pt-14px pr-300px pb-14px pl-300px bg-[#ffffff]'>
        ...
        <div className='w-[1000px] h-[139px] top-[950px] left-[260px] absolute justify-between hover:bg-[#c5cde6]'>
              <Image src='/Logo.png' alt='logo' className='hover:bg-[#f0f2f8] rounded-2xl absolute' height={130} width={130}></Image>
              <Image src='/Logo (1).png' alt='logo 1' className='hover:bg-[#f0f2f8] drop-shadow-md hover:drop-shadow-[#f0f2f8] left-[160px] top-[5px] rounded-2xl absolute' height={130} width={130}></Image>
              <Image src='/Logo (2).png' alt='logo 2' className='hover:bg-[#f0f2f8] left-[300px] top-[5px] rounded-2xl absolute' height={130} width={130}></Image>
              <Image src='/Logo (3).png' alt='logo 3' className='hover:bg-[#f0f2f8] left-[430px] top-[5px] rounded-2xl absolute' height={130} width={130}></Image>
              <Image src='/Logo (4).png' alt='logo 4' className='hover:bg-[#f0f2f8] left-[550px] top-[5px] rounded-2xl absolute' height={130} width={130}></Image>
              <Image src='/Logo (5).png' alt='logo 5' className='hover:bg-[#f0f2f8] left-[695px] top-[5px] rounded-2xl absolute' height={130} width={130}></Image>
              <Image src='/Logo (6).png' alt='logo 6' className='hover:bg-[#f0f2f8] left-[865px] top-[5px] rounded-2xl absolute' height={130} width={130}></Image>
            </div>
        ...
        <h3 className='w-[px] h-[31px] top-[1140px] left-[250px] right-[250px] absolute  font-bold text-[30px]  text-[#272343] font-inter no-underline hover:underline'>Featured Product</h3>
            <div className='w-[312px] h-[377px] top-[1210px] left-[1030px] absolute hover:'><Image src='/Products.png' alt='product 1' width={250} height={250}></Image></div>
            <div data-aos="zoom-out-up" className='w-[312px] h-[377px] top-[1210px] left-[760px] absolute'><Image src='/Products (2).png' alt='product 2' width={250} height={250}></Image></div>
            <div className='w-[312px] h-[377px] top-[1210px] left-[490px] absolute'><Image src='/Products (1).png' alt='product 3' width={250} height={250}></Image></div>
            <div className='w-[312px] h-[377px] top-[1210px] left-[220px] absolute'><Image src='/Products (3).png' alt='produc 4' width={250} height={250}></Image></div>
            ...
            <h4 className='w-[px] h-[31px] top-[1590px] right-[930px] absolute  font-bold text-[30px]  text-[#272343] font-inter no-underline hover:underline'>Top categories</h4>
                <div className='w-[400px] h-[377px] top-[1670px] left-[930px] absolute'><Image src='/Category.png' alt='category' width={350} height={350}></Image></div>
                <div className='w-[420px] h-[377px] top-[1670px] left-[560px] absolute'><Image src='/Category (1).png' alt='category 1' width={350} height={350}></Image></div>
                <div className='w-[420px] h-[377px] top-[1670px] left-[190px] absolute'><Image src='/Category (2).png' alt='category' width={350} height={350}></Image></div>
            ...
            <h5 className='w-[580px] h-[10px] top-[2350px] right-[880px] -rotate-90 absolute text-[27px] leading-[39.84px] no-underlineunderline hover:underline'>EXPLORE NEW AND POPULAR STYLES</h5>
                <div className='w-[710px] h-[77px] top-[2170px] left-[205px] absolute'><Image src='/item-category 1.png' alt='product' width={510} height={510}></Image></div>
                <div className='w-[330px] h-[377px] top-[2425px] left-[1000px] absolute'><Image src='/card.png' alt='card 1' width={250} height={250}></Image></div>
                <div className='w-[330px] h-[377px] top-[2165px] left-[1000px] absolute'><Image src='/card (1).png' alt='card 2' width={250} height={250}></Image></div>
                <div className='w-[330px] h-[377px] top-[2165px] left-[730px] absolute'><Image src='/card (2).png' alt='card 3' width={250} height={250}></Image></div>
                <div className='w-[330px] h-[377px] top-[2425px] left-[730px] absolute'><Image src='/card (3).png' alt='card 4' width={250} height={250}></Image></div>
            ...
            <h6 className='w-[678px] h-[52px] top-[2770px] left-[590px]  absolute text-[39px] leading-[39.84px] no-underlineunderline hover:underline'>Our Products</h6>
              <div className='w-[330px] h-[377px] top-[3225px] left-[1000px] absolute'><Image src='/Products(4).png' alt='card 1' width={250} height={250}></Image></div>
                <div className='w-[330px] h-[377px] top-[2900px] left-[1000px] absolute'><Image src='/Products(5).png' alt='card 2' width={250} height={250}></Image></div>
                <div className='w-[330px] h-[377px] top-[3225px] left-[730px] absolute'><Image src='/Products(6).png' alt='card 3' width={250} height={250}></Image></div>
                <div className='w-[330px] h-[377px] top-[2900px] left-[730px] absolute'><Image src='/Products(7).png' alt='card 4' width={250} height={250}></Image></div>
                <div className='w-[330px] h-[377px] top-[3225px] left-[460px] absolute'><Image src='/Products(8).png' alt='card 5' width={250} height={250}></Image></div>
                <div className='w-[330px] h-[377px] top-[2900px] left-[460px] absolute'><Image src='/Products(9).png' alt='card 6' width={250} height={250}></Image></div>
                <div className='w-[330px] h-[377px] top-[3225px] left-[190px] absolute'><Image src='/Products (10).png' alt='card 7' width={250} height={250}></Image></div>
                <div className='w-[330px] h-[377px] top-[2900px] left-[190px] absolute'><Image src='/Products(11).png' alt='card 8' width={250} height={250}></Image></div>
        ...
        <div className='w-[1343px] h-[343px] top-[3750px] absolute  bg-[#ffffff] border border-[#9A9CAA]'></div>
            ...
            <Image src='/footer2.png' alt='footer' className='absolute top-[90px] w-[540px] h-[40px]' width={640} height={40} ></Image>
            </div>
            </div>  
